...
# 発射
    ## hand_gun
        ...
        execute if predicate guncraft:have/off/hand_gun if score @s GunCraft.use_hand matches -1 at @s anchored eyes positioned ^0.2 ^ ^ run function guncraft:core/hand_gun/shot
        execute if predicate guncraft:have/main/hand_gun if score @s GunCraft.use_hand matches 1 at @s anchored eyes positioned ^-0.2 ^ ^ run function guncraft:core/hand_gun/shot
    ...
    ## lazer_hand_gun
        ...
        execute if predicate guncraft:have/main/lazer_hand_gun if score @s GunCraft.use_hand matches 1 at @s anchored eyes positioned ^-0.2 ^ ^ run function guncraft:core/lazer_hand_gun/shot
        execute if predicate guncraft:have/off/lazer_hand_gun if score @s GunCraft.use_hand matches -1 at @s anchored eyes positioned ^0.2 ^ ^ run function guncraft:core/lazer_hand_gun/shot
    ...
    ## fire_gun
        ...
        execute if predicate guncraft:have/main/fire_gun if score @s GunCraft.use_hand matches 1 at @s anchored eyes positioned ^-0.2 ^ ^ run function guncraft:core/fire_gun/shot
        execute if predicate guncraft:have/off/fire_gun if score @s GunCraft.use_hand matches -1 at @s anchored eyes positioned ^0.2 ^ ^ run function guncraft:core/fire_gun/shot
